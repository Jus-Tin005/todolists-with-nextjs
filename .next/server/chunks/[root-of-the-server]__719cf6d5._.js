module.exports = [
"[project]/.next-internal/server/app/api/todos/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function ml(e, r) {
    ...
    let o = await ir(), s = r.generator?.binaryTargets ?? [], a = s.some((d)=>d.native), l = !s.some((d)=>d.value === o), u = ("TURBOPACK compile-time value", "/ROOT/app/generated/prisma/runtime/library.js").match(Qm()) === null, c = {
        searchedLocations: i,
...
async function Wm(e, r) {
    ...
    ("TURBOPACK compile-time value", "/ROOT/app/generated/prisma/runtime/library.js").includes("resolveEnginePath") && i.push(ms());
    for (let o of i){
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "/home/khuntunlar/todolists-with-nextjs/app/generated/prisma",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/khuntunlar/todolists-with-nextjs/prisma/schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
...
path.join(("TURBOPACK compile-time value", "/ROOT/app/generated/prisma"), "libquery_engine-debian-openssl-3.0.x.so.node");
